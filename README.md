...
It is a Simple web project that is made for e-channeling Using PHP,HTML & CSS.
...
7. Browse the Doctor's Appointment Systsem in a browser. i.e. http://localhost/doctor-appointment.
